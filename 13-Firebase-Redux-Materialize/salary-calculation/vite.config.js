...
export default defineConfig({
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'Nomina salary calculation app React + Redux + Firebase',
        short_name: 'Nominal App',
        start_url: '.',
        display: 'standalone',
        theme_color: '#3fe496',
        background_color: '#088b83',
        description: 'Aplication with google login, redux, firestore using react',
        lang: 'es',
        icons: [
          {
